            ...
            <div className={classes.overlapGroup1}>
              ...
              <div className={classes.overlapGroup4}>
                <p className={classes.scenario}>
                  ...
                  <span className={classes.droidsansRegularNormalCerulean9pxText}> Split dev and production pipeline with local developers</span>
                </p>
              ...
              <div className={classes.overlapGroup3}>
                <p className={classes.scenario}>
                  <span className={classes.droidsansBoldCerulean9pxText}>Scenario 2: </span>
              ...
              <div className={classes.overlapGroup22}>
                <p className={classes.scenario}>
                  <Typography className={classes.droidsansBoldCerulean9pxText}>Scenario 3:</Typography>
                ...
                <p className={classes.registerWith3}>
                  ...
                  <Link href="#" className={classes.span1}>here</Link>
